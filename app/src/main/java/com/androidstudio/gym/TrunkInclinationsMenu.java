...
public class TrunkInclinationsMenu extends AppCompatActivity {
    float i = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trunk_inclinations_menu);
        ...
        plan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinationsMenu.this, MainActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinationsMenu.this, Profile.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        lessons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinationsMenu.this, Lessons.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void Click(View view) {
        ...
        if (tv.getCurrentTextColor() == getResources().getColor(R.color.titleclr)) {
            ...
            Intent intent = new Intent(TrunkInclinationsMenu.this, TrunkInclinations.class);
