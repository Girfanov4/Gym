...
public class TrunkInclinations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trunk_inclinations);
        ...
        plan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinations.this, MainActivity.class);
        ...
        lessons.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinations.this, Lessons.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TrunkInclinations.this, Profile.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onStopButtonClick(View view) {
        ...
        if (isPaused = false) {
            ...
            Intent intent = new Intent(TrunkInclinations.this, TrunkInclinationsStop.class);
